package com.deltasoft365.photoeditor
...
class ExpoPhotoEditorModule : Module() {
	...
	override fun definition() = ModuleDefinition {
		...
		AsyncFunction("open") { options: ReadableMap?, promise: Promise ->
			this@ExpoPhotoEditorModule.promise = promise
			val activity = this@ExpoPhotoEditorModule.appContext.currentActivity
			if (activity == null) {
