...
public class ExpoPhotoEditorModule: Module {
	var window: UIWindow?
	...
	public func definition() -> ModuleDefinition {
		Name("ExpoPhotoEditor")

		AsyncFunction("open") { (options: PhotoEditorOptions, promise: Promise) in
	...
	private func setConfiguration(options: PhotoEditorOptions, promise: Promise) -> Void{
...
internal struct PhotoEditorOptions: Record {
	@Field
	var path: String?
